...
const Amenities = () => {
  return (
    <section className="overflow-hidden">
      ...
      <Image src={Amenities1} alt="Amenities" className="w-full h-auto" />
      ...
      <Image src={Amenities2} alt="Amenities" className="w-full h-auto" />
      ...
      <div className="bg-black text-white grid grid-cols-1 md:grid-cols-2 px-4 sm:px-8 md:px-16 lg:px-32 xl:px-60 py-16 md:py-32 gap-10">
        <Image src={live} alt="Live Secure" className="w-full h-auto" />
        <div>
