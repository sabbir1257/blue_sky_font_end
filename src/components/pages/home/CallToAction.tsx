    ...
    <section className="relative bg-white text-blue-900 py-24 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="mt-10 flex justify-center flex-wrap gap-5">
          <Link href="/contact">
            <button className="bg-white border border-blue-600 text-blue-700 hover:bg-blue-600 hover:text-white font-semibold px-6 py-3 rounded-full shadow-lg flex items-center gap-2 transition duration-300">
              <FaRocket />
              Contact Us
            </button>
          </Link>
